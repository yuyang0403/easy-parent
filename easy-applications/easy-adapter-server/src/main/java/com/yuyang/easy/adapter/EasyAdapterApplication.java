package com.yuyang.easy.adapter;
...
@EnableAsync
public class EasyAdapterApplication {
    private static final Logger log = LoggerFactory.getLogger(EasyAdapterApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(EasyAdapterApplication.class, args);
        log.info("适配服务-启动成功........");
    }
