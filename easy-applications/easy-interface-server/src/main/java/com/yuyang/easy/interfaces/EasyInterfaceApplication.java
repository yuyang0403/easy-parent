package com.yuyang.easy.interfaces;
...
@EnableAsync
public class EasyInterfaceApplication {
    private static final Logger log = LoggerFactory.getLogger(EasyInterfaceApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(EasyInterfaceApplication.class, args);
        log.info("接口服务-启动成功........");
    }
