...
@MapperScan("com.yuyang.easy.customer.mapper")
@EnableAsync
public class EasyCustomerApplication {
    private static final Logger log = LoggerFactory.getLogger(EasyCustomerApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(EasyCustomerApplication.class, args);
        log.info("用户服务-启动成功........");
    }
